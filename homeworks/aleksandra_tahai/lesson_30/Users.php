...
class Users
{
    ...
    public function __construct(PDO $connection, string $firstName, string $lastName, string $email)
    {
...
$popik = new Users($connection, "loliki", "popiki", "et3t3gewfwfrrrrrr");
$id = $popik->createUser();
print_r($id);
$new = $popik->getUserById($id);
var_dump($new);
$popik->deleteUserById($id);
//$popik->updateUser('dcf','dfd','jkijikj');
