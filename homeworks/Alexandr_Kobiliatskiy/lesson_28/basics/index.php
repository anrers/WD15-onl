...
<body>
    ...
    ?>
    <div class='container bg-secondary-subtle p-4'>
        <p><a class="link-opacity-100" href="lookAll.php">На страницу просмотра всех студентов</a></p>
        <p><a class="link-opacity-100" href="addEnrollments.php">На страницу, посвященную таблице enrollments</a></p>
    </div>
